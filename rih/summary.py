...
def main():
    ...
    parser.add_argument("input_file", help="Input data file, as created by datagen.py")
    ...
    stats = gdf[[util.VARIABLE_TOTAL_POP, util.VARIABLE_MEDIAN_INCOME, util.VARIABLE_MEDIAN_VALUE]].describe(
